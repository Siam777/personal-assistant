...
updated: 2026-08-20T05:15:00Z
---

## Current Test

number: 1
name: Create one entry of each of the four types (API key, login, secure note, card) through the real UI and confirm each appears in the list immediately without a page reload
expected: |
  New entry appears in EntryListScreen without navigation/reload; only that type's fields are shown on the form
